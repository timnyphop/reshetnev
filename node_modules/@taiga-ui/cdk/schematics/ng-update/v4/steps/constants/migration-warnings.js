...
const ILLUSTRATION_WARNING_MESSAGE = 'TuiIllustrationsModule and TuiIllustrationModePipe were deleted. Import TuiIconPipe and use <img [src]="\'@tui.illustration.pack.icon-name\' | tuiIcon" /> instead. See https://taiga-ui.tcsbank.ru/icons';
exports.MIGRATION_WARNINGS = [
    ...
    },
    {
        ...
        moduleSpecifier: '@taiga-ui/core',
        message: 'Use processors from Maskito instead https://maskito.dev/core-concepts/processors',
    },
    {
    ...
    },
    {
        ...
        moduleSpecifier: '@taiga-ui/kit',
        message: 'Use DateRange mask from Maskito instead https://maskito.dev/kit/date-range',
    },
    {
    ...
    },
    {
        ...
        moduleSpecifier: '@taiga-ui/kit',
        message: 'Use DateTime mask from Maskito instead https://maskito.dev/kit/date-time',
    },
    {
    ...
    },
    {
        name: 'EMPTY_MASK',
        moduleSpecifier: '@taiga-ui/kit',
        message: 'Use Maskito instead https://maskito.dev (use MASKITO_DEFAULT_OPTIONS or just pass null to [maskito]-directive)',
    },
    {
        name: 'TextMaskModule',
        moduleSpecifier: '@taiga-ui/kit',
    ...
    },
    {
        ...
        moduleSpecifier: '@taiga-ui/addon-commerce',
        message: 'Use Date mask (with [mode]="mm/yyyy") from Maskito instead https://maskito.dev/kit/date/API?mode=mm%2Fyyyy',
    },
    {
        name: 'TuiMaskAccessorModule',
        moduleSpecifier: '@taiga-ui/core',
        message: 'Use Maskito instead (this MaskAccessor is not required for it) https://maskito.dev/frameworks/angular#custom-input',
    },
    {
