const TUI_HEBREW_LANGUAGE_ADDON_COMMERCE = {
    cardNumber: ['מספר', 'מספר כרטיס'],
    cardExpiry: ['פג תוקף', 'בתוקף עד'],
};

const TUI_HEBREW_LANGUAGE_ADDON_EDITOR = {
...
const TUI_HEBREW_LANGUAGE_ADDON_TABLE = {
...
const TUI_HEBREW_LANGUAGE_COUNTRIES = {
    AD: 'Andorra',
...
const TUI_HEBREW_LANGUAGE_CORE = {
    months: [
        'יָנוּאָר',
        'פברואר',
        'מרץ',
...
export { TUI_HEBREW_LANGUAGE, TUI_HEBREW_LANGUAGE_ADDON_COMMERCE, TUI_HEBREW_LANGUAGE_ADDON_EDITOR, TUI_HEBREW_LANGUAGE_ADDON_TABLE, TUI_HEBREW_LANGUAGE_CORE, TUI_HEBREW_LANGUAGE_COUNTRIES, TUI_HEBREW_LANGUAGE_KIT };
//# sourceMappingURL=taiga-ui-i18n-languages-hebrew.mjs.map
