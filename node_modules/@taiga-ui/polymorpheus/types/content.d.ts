 ...
 */
export type PolymorpheusContent<C = any> = PolymorpheusComponent<unknown> | PolymorpheusHandler<C> | PolymorpheusPrimitive | PolymorpheusTemplate<Partial<C> | ''> | TemplateRef<Partial<C>>;
