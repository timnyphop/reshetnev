import { NgIf, AsyncPipe, PercentPipe } from '@angular/common';
import * as i0 from '@angular/core';
import { Directive, inject, EventEmitter, Component, ChangeDetectionStrategy, Input, Output, ViewEncapsulation, Injectable } from '@angular/core';
