...
function TuiCalendarMonth_ng_template_1_ng_container_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 9);
    ɵɵlistener("click", function TuiCalendarMonth_ng_template_1_ng_container_4_div_1_Template_div_click_0_listener() {
      const item_r5 = ɵɵrestoreView(_r4).tuiLet;
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.onItemClick(item_r5));
    })("tuiHoveredChange", function TuiCalendarMonth_ng_template_1_ng_container_4_div_1_Template_div_tuiHoveredChange_0_listener($event) {
      const item_r5 = ɵɵrestoreView(_r4).tuiLet;
      const ctx_r1 = ɵɵnextContext(3);
  ...
  if (rf & 2) {
    ...
    ɵɵclassProp("t-cell_disabled", ctx_r1.disabledItemHandlerWithMinMax(item_r5))("t-cell_interval", ctx_r1.isItemInsideRange(item_r5))("t-cell_today", ctx_r1.isItemToday(item_r5));
    ɵɵattribute("data-range", ctx_r1.getItemRange(item_r5));
    ɵɵadvance(2);
    ɵɵtextInterpolate(month_r6);
  }
}
function TuiCalendarMonth_ng_template_1_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiCalendarMonth_ng_template_1_ng_container_4_div_1_Template, 3, 8, "div", 8);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵproperty("tuiLet", ctx_r1.getTuiMonth(index_r7, ctx_r1.year.year));
  }
}
function TuiCalendarMonth_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(4, TuiCalendarMonth_ng_template_1_ng_container_4_Template, 2, 1, "ng-container", 7);
    ɵɵpipe(5, "async");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngForOf", ɵɵpipeBind1(5, 5, ctx_r1.months$));
  }
}
var TODAY = TuiDay.currentLocal();
var _TuiCalendarMonth = class _TuiCalendarMonth {
  constructor() {
...
_TuiCalendarMonth.ɵfac = function TuiCalendarMonth_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendarMonth)();
};
_TuiCalendarMonth.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 2,
  consts: [["monthSelect", ""], ["class", "t-scrollbar", 4, "ngIf", "ngIfElse"], [1, "t-scrollbar"], [3, "yearClick", "initialItem", "max", "min", "value"], [3, "leftClick", "rightClick", "focusable", "leftDisabled", "rightDisabled"], ["automation-id", "tui-calendar-month__active-year", "tabIndex", "-1", "tuiLink", "", "type", "button", 3, "click"], [1, "t-row"], [4, "ngFor", "ngForOf"], ["class", "t-cell", 3, "t-cell_disabled", "t-cell_interval", "t-cell_today", "click", "tuiHoveredChange", 4, "tuiLet"], [1, "t-cell", 3, "click", "tuiHoveredChange"], [1, "t-item"]],
  template: function TuiCalendarMonth_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, TuiCalendarMonth_tui_scrollbar_0_Template, 2, 4, "tui-scrollbar", 1)(1, TuiCalendarMonth_ng_template_1_Template, 6, 7, "ng-template", null, 0, ɵɵtemplateRefExtractor);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiCalendarMonth, [{
    ...
    args: [{
      ...
      imports: [AsyncPipe, NgIf, NgForOf, TuiCalendarYear, TuiSpinButton, TuiScrollbar, TuiLink, TuiLet, TuiHovered],
      changeDetection: ChangeDetectionStrategy.OnPush,
      host: {
...
var _c1 = "[_nghost-%COMP%]{display:block}.t-content[_ngcontent-%COMP%]{flex:1}.t-loader[_ngcontent-%COMP%]{margin:.75rem 0}";
...
_TuiDataListWrapperComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiDataListComponent, TuiOption, NgIf, NgForOf, TuiElement, TuiLoader, PolymorpheusOutlet],
...
_TuiDataListGroupWrapperComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiDataListComponent, TuiOption, TuiOptGroup, NgIf, NgForOf, TuiElement, PolymorpheusOutlet, TuiLoader],
  styles: [_c1],
  changeDetection: 0
});
...
_TuiSliderComponent.ɵcmp = ɵɵdefineComponent({
...
_TuiSliderKeySteps.ɵdir = ɵɵdefineDirective({
...
_TuiSliderReadonly.ɵdir = ɵɵdefineDirective({
...
_TuiSliderThumbLabel.ɵcmp = ɵɵdefineComponent({
...
var _TuiRangeChange = class _TuiRangeChange {
  constructor() {
    this.doc = inject(DOCUMENT);
    this.el = tuiInjectElement();
...
_TuiRangeChange.ɵfac = function TuiRangeChange_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiRangeChange)();
};
_TuiRangeChange.ɵdir = ɵɵdefineDirective({
...
var TuiRangeChange = _TuiRangeChange;
(() => {
...
var _TuiRange = class _TuiRange extends TuiControl {
  constructor() {
    super(...arguments);
...
_TuiRange.ɵcmp = ɵɵdefineComponent({
  type: _TuiRange,
  selectors: [["tui-range"]],
  ...
  dependencies: [TuiSliderComponent, TuiSliderKeySteps, TuiSliderReadonly, FormsModule, DefaultValueAccessor, RangeValueAccessor, NgControlStatus, NgModel],
...
var _TuiStringifyContentPipe = class _TuiStringifyContentPipe {
  transform(stringify) {
    return ({
      $implicit
    }) => stringify($implicit);
...
_TuiStringifyContentPipe.ɵfac = function TuiStringifyContentPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiStringifyContentPipe)();
};
_TuiStringifyContentPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiStringifyContent",
  type: _TuiStringifyContentPipe,
  pure: true,
  standalone: true
});
var TuiStringifyContentPipe = _TuiStringifyContentPipe;
(() => {
...
function normalizeDatePreprocessor({
  ...
  return ({
    ...
    const dates = data.includes(dateTimeSeparator) ? [possibleDates[0] || ""] : possibleDates;
...
function normalizeDateString(dateString, template, separator) {
  ...
  const normalizedSegments = dateSegments.map((segment, index) => {
    var _a;
    return index === templateSegments.length - 1 ? segment : segment.padStart(((_a = templateSegments[index]) === null || _a === void 0 ? void 0 : _a.length) || 0, "0");
  });
...
function createTimeSegmentsIndexes(fullMode) {
  return /* @__PURE__ */ new Map([["hours", getSegmentRange(fullMode, "HH")], ["minutes", getSegmentRange(fullMode, "MM")], ["seconds", getSegmentRange(fullMode, "SS")], ["milliseconds", getSegmentRange(fullMode, "MSS")]]);
}
...
function isDateTimeStringComplete(dateTimeString, {
  ...
  return dateTimeString.length >= dateMode.length + timeMode.length + dateTimeSeparator.length && (dateTimeString.split(dateTimeSeparator)[0] || "").split(/\D/).every((segment) => !segment.match(/^0+$/));
}
...
//# sourceMappingURL=chunk-75V473TQ.js.map
