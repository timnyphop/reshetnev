...
_TuiExpandComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiLoader, NgIf, NgTemplateOutlet],
...
_TuiAlertComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 6,
  vars: 7,
  consts: [["size", "m", 3, "appearance", "icon"], ["tuiTitle", ""], [4, "polymorpheusOutlet", "polymorpheusOutletContext"], ["tuiSubtitle", ""], [3, "innerHTML", 4, "polymorpheusOutlet", "polymorpheusOutletContext"], ["tuiIconButton", "", 3, "iconStart", "click", 4, "ngIf"], [3, "innerHTML"], ["tuiIconButton", "", 3, "click", "iconStart"]],
  ...
  dependencies: [NgIf, PolymorpheusOutlet, TuiNotification, TuiButton, TuiTitle],
  styles: ["[_nghost-%COMP%]{display:block;inline-size:18rem;flex-shrink:0;background:var(--tui-background-elevation-1);border-radius:var(--tui-radius-m);box-shadow:var(--tui-shadow-medium)}[_nghost-%COMP%]:not(:first-child){margin-top:.75rem!important}[_nghost-%COMP%]:not(:last-child){margin-bottom:0!important}"],
  data: {
...
//# sourceMappingURL=chunk-LB2XXWI4.js.map
