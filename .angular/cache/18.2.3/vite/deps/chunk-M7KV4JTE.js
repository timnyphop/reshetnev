...
_TuiLoader.ɵcmp = ɵɵdefineComponent({
  type: _TuiLoader,
...
var TUI_DARK_MODE = new InjectionToken("", {
  factory: () => {
    let automatic = true;
...
_TuiAppearance.ɵdir = ɵɵdefineDirective({
  ...
  hostBindings: function TuiAppearance_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("data-appearance", ctx.appearance())("data-state", ctx.state())("data-focus", ctx.focus());
    }
  },
  inputs: {
...
_TuiWithAppearance.ɵdir = ɵɵdefineDirective({
  ...
  features: [ɵɵHostDirectivesFeature([{
    ...
    inputs: ["tuiAppearance", "appearance", "tuiAppearanceState", "tuiAppearanceState", "tuiAppearanceFocus", "tuiAppearanceFocus"]
  }])]
});
...
var _TuiScrollbarDirective = class _TuiScrollbarDirective {
  constructor() {
    ...
    this.styleSub = merge(inject(WA_ANIMATION_FRAME).pipe(throttleTime(100)), tuiScrollFrom(this.el)).pipe(tuiZonefree(), takeUntilDestroyed()).subscribe(() => {
      const dimension = {
...
var _c2 = ["*"];
var _TuiDropdownDriver = class _TuiDropdownDriver extends Subject {
  constructor() {
    super(...arguments);
    this.type = "dropdown";
  }
};
_TuiDropdownDriver.ɵfac = /* @__PURE__ */ (() => {
...
var TUI_DROPDOWN_CONTEXT = new InjectionToken("");
...
_TuiDropdownComponent.ɵcmp = ɵɵdefineComponent({
  ...
  styles: ["[_nghost-%COMP%]{position:absolute;display:flex;box-shadow:var(--tui-shadow-medium);background:var(--tui-background-elevation-2);border-radius:var(--tui-radius-m);overflow:hidden;border:1px solid var(--tui-border-normal);box-sizing:border-box;max-inline-size:calc(100% - 8px);isolation:isolate;pointer-events:auto}.ng-animating[_nghost-%COMP%]{pointer-events:none}[_nghost-%COMP%]:not([style*=top]){visibility:hidden}.t-scroll[_ngcontent-%COMP%]{flex-grow:1;max-inline-size:100%;overscroll-behavior:none}.t-primitive[_ngcontent-%COMP%]{padding:1rem}"],
  data: {
  ...
  hostBindings: function TuiDropdownContext_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("touchend.silent.passive", function TuiDropdownContext_touchend_silent_passive_HostBindingHandler() {
        ...
        return ctx.closeDropdown($event.target);
      }, false, ɵɵresolveDocument)("keydown.esc", function TuiDropdownContext_keydown_esc_HostBindingHandler($event) {
...
var _TuiAutoColorPipe = class _TuiAutoColorPipe {
  transform(text) {
    return tuiStringHashToHsl(text);
  }
};
_TuiAutoColorPipe.ɵfac = function TuiAutoColorPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiAutoColorPipe)();
};
_TuiAutoColorPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiAutoColor",
  type: _TuiAutoColorPipe,
  pure: true,
  standalone: true
});
var TuiAutoColorPipe = _TuiAutoColorPipe;
(() => {
...
var _TuiCalendarSheetPipe = class _TuiCalendarSheetPipe {
  constructor() {
...
_TuiCalendarSheetPipe.ɵfac = function TuiCalendarSheetPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendarSheetPipe)();
};
_TuiCalendarSheetPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiCalendarSheet",
  type: _TuiCalendarSheetPipe,
  pure: true,
  standalone: true
});
var TuiCalendarSheetPipe = _TuiCalendarSheetPipe;
(() => {
...
var _TuiFallbackSrcPipe = class _TuiFallbackSrcPipe {
  constructor() {
    this.el = tuiInjectElement();
  }
...
_TuiFallbackSrcPipe.ɵfac = function TuiFallbackSrcPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiFallbackSrcPipe)();
};
_TuiFallbackSrcPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiFallbackSrc",
  type: _TuiFallbackSrcPipe,
  pure: true,
  standalone: true
});
var TuiFallbackSrcPipe = _TuiFallbackSrcPipe;
(() => {
...
var _TuiFormatDatePipe = class _TuiFormatDatePipe {
  constructor() {
...
_TuiFormatDatePipe.ɵfac = function TuiFormatDatePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiFormatDatePipe)();
};
_TuiFormatDatePipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiFormatDate",
  type: _TuiFormatDatePipe,
  pure: true,
  standalone: true
});
var TuiFormatDatePipe = _TuiFormatDatePipe;
(() => {
...
var _TuiFormatNumberPipe = class _TuiFormatNumberPipe {
  constructor() {
...
_TuiFormatNumberPipe.ɵfac = function TuiFormatNumberPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiFormatNumberPipe)();
};
_TuiFormatNumberPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiFormatNumber",
  type: _TuiFormatNumberPipe,
  pure: true,
  standalone: true
});
var TuiFormatNumberPipe = _TuiFormatNumberPipe;
(() => {
...
_TuiInitialsPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiInitials",
...
var _TuiMonthPipe = class _TuiMonthPipe {
  constructor() {
...
_TuiMonthPipe.ɵfac = function TuiMonthPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiMonthPipe)();
};
_TuiMonthPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiMonth",
  type: _TuiMonthPipe,
  pure: true,
  standalone: true
});
var TuiMonthPipe = _TuiMonthPipe;
(() => {
...
var _TuiOrderWeekDaysPipe = class _TuiOrderWeekDaysPipe {
  constructor() {
...
_TuiOrderWeekDaysPipe.ɵfac = function TuiOrderWeekDaysPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiOrderWeekDaysPipe)();
};
_TuiOrderWeekDaysPipe.ɵpipe = ɵɵdefinePipe({
  name: "tuiOrderWeekDays",
  type: _TuiOrderWeekDaysPipe,
  pure: true,
  standalone: true
});
var TuiOrderWeekDaysPipe = _TuiOrderWeekDaysPipe;
(() => {
...
var _TuiSpinButton = class _TuiSpinButton {
  constructor() {
...
_TuiSpinButton.ɵfac = function TuiSpinButton_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiSpinButton)();
};
_TuiSpinButton.ɵcmp = ɵɵdefineComponent({
  type: _TuiSpinButton,
  ...
  dependencies: [TuiButton, NgIf, AsyncPipe],
...
var TuiSpinButton = _TuiSpinButton;
(() => {
...
var _c06 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
...
function TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_div_4_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "div", 12);
  }
  if (rf & 2) {
...
function TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 11);
    ɵɵelement(1, "div", 12);
    ɵɵtemplate(2, TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_div_4_div_2_Template, 1, 2, "div", 13);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵpipe(2, "tuiMapper");
    ɵɵtext(3);
    ɵɵtemplate(4, TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_div_4_Template, 3, 3, "div", 10);
    ɵɵpipe(5, "tuiMapper");
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const item_r3 = ɵɵnextContext().tuiLet;
    const ctx_r3 = ɵɵnextContext(4);
    ɵɵclassProp("t-cell_disabled", ctx_r3.disabledItemHandler(item_r3))("t-cell_interval", ctx_r3.itemIsInterval(item_r3))("t-cell_today", ctx_r3.itemIsToday(item_r3))("t-cell_unavailable", ctx_r3.itemIsUnavailable(item_r3));
    ɵɵattribute("data-range", ctx_r3.getItemRange(item_r3));
    ɵɵadvance();
    ɵɵclassProp("t-item_unavailable", ctx_r3.itemIsUnavailable(item_r3));
    ɵɵattribute("data-type", ɵɵpipeBind2(2, 14, item_r3, ctx_r3.dayTypeHandler));
    ɵɵadvance(2);
    ɵɵtextInterpolate1(" ", item_r3.day, " ");
    ɵɵadvance();
    ɵɵproperty("ngIf", ɵɵpipeBindV(5, 17, ɵɵpureFunction5(23, _c06, item_r3, ctx_r3.toMarkers, ctx_r3.itemIsToday(item_r3), !!ctx_r3.getItemRange(item_r3), ctx_r3.markerHandler)));
  }
}
function TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_Template, 6, 29, "div", 7);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function TuiCalendarYear_div_0_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(3);
    ɵɵclassProp("t-cell_disabled", ctx_r2.isDisabled(item_r2))("t-cell_interval", ctx_r2.itemIsInterval(item_r2))("t-cell_today", ctx_r2.itemIsToday(item_r2));
...
function TuiCalendarYear_div_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiCalendarYear_div_0_ng_container_1_div_1_Template, 3, 9, "div", 3);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
var _TuiCalendarSheet = class _TuiCalendarSheet {
  constructor() {
  ...
  getItemRange(item) {
    ...
    if (value.from.daySame(item) && !value.isSingleDay || hoveredItem?.dayAfter(value.from) && value.from.daySame(item) && value.isSingleDay || hoveredItem?.daySame(item) && hoveredItem.dayBefore(value.from) && value.isSingleDay) {
      return "start";
    }
    if (value.to.daySame(item) && !value.isSingleDay || hoveredItem?.dayBefore(value.from) && value.from.daySame(item) && value.isSingleDay || hoveredItem?.daySame(item) && hoveredItem.dayAfter(value.from) && value.isSingleDay) {
      return "end";
    }
...
_TuiCalendarSheet.ɵfac = function TuiCalendarSheet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendarSheet)();
};
_TuiCalendarSheet.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [CommonModule, NgForOf, NgIf, AsyncPipe, TuiLet, TuiMapperPipe, TuiRepeatTimes, TuiHovered, TuiCalendarSheetPipe, TuiOrderWeekDaysPipe],
  styles: ['[_nghost-%COMP%]{display:block;font:var(--tui-font-text-m)}.t-row[_ngcontent-%COMP%]{position:relative;display:flex;justify-content:space-between;block-size:2.25rem;isolation:isolate}.t-item[_ngcontent-%COMP%]{position:relative;flex:1;line-height:2rem;border-radius:var(--tui-radius-m)}.t-item[_ngcontent-%COMP%]:before, .t-item[_ngcontent-%COMP%]:after{position:absolute;top:0;left:0;bottom:0;right:0;content:"";z-index:-1;border-radius:var(--tui-radius-m)}.t-item[_ngcontent-%COMP%]:after{border-radius:.5rem}.t-cell[_ngcontent-%COMP%]{position:relative;display:flex;align-items:center;justify-content:center;inline-size:2.25rem;text-align:center;outline:none;cursor:pointer;background-clip:content-box;box-sizing:border-box;border:.125rem solid transparent}.t-cell[_ngcontent-%COMP%]:before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;z-index:-1;border-radius:var(--tui-radius-m)}.t-cell_today[_ngcontent-%COMP%]:after{position:absolute;left:50%;transform:translate(-50%);content:"";bottom:.3125rem;block-size:.125rem;inline-size:.75rem;border-radius:.375rem;background:var(--tui-text-primary)}.t-cell_interval[_ngcontent-%COMP%]:before{background:var(--tui-background-base-alt)}._single[_nghost-%COMP%]   .t-cell_interval[_ngcontent-%COMP%]:before{background:var(--tui-background-neutral-1-hover)}.t-cell_interval[_ngcontent-%COMP%]:not(:last-child):before{right:-.1875rem;border-start-end-radius:0;border-end-end-radius:0}.t-cell_interval[_ngcontent-%COMP%]:not([data-range=start]):not(:first-child):before{border-start-start-radius:0;border-end-start-radius:0}.t-cell_interval[_ngcontent-%COMP%]:last-child:first-child:before{right:0}.t-cell_interval[_ngcontent-%COMP%]:first-child > .t-item[_ngcontent-%COMP%]{border-start-start-radius:var(--tui-radius-m);border-end-start-radius:var(--tui-radius-m)}.t-cell_interval[_ngcontent-%COMP%]:last-child > .t-item[_ngcontent-%COMP%]{border-start-end-radius:var(--tui-radius-m);border-end-end-radius:var(--tui-radius-m)}.t-cell_interval[_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{border-radius:0}.t-cell[data-range][_ngcontent-%COMP%]:after{background:var(--tui-text-primary-on-accent-1)}.t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{color:var(--tui-text-primary-on-accent-1)}.t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1)}.t-cell[data-range][_ngcontent-%COMP%]:hover > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%]:hover > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1-hover)}.t-cell[data-range][_ngcontent-%COMP%]:active > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%]:active > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1-pressed)}.t-cell[data-range=end][_ngcontent-%COMP%]:before{background:var(--tui-background-base-alt)}._single[_nghost-%COMP%]   .t-cell[data-range=end][_ngcontent-%COMP%]:before{background:var(--tui-background-neutral-1-hover)}.t-cell[data-range=end][_ngcontent-%COMP%]:not(:first-child):before{border-start-start-radius:0;border-end-start-radius:0}.t-cell[data-range=end][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before{left:.625rem;border-start-start-radius:0;border-end-start-radius:0}.t-cell[data-range=end][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{left:-2rem;right:100%;transform:translate(1.6rem) scaleY(.83) scaleX(.5) rotate(45deg)}.t-cell[data-range=start][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before{right:.625rem;border-start-end-radius:0;border-end-end-radius:0}.t-cell[data-range=start][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{left:100%;right:-2rem;transform:translate(-1.6rem) scaleY(.83) scaleX(.5) rotate(45deg)}.t-cell[data-range=single][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{display:none}.t-cell_disabled[_ngcontent-%COMP%]{pointer-events:none}.t-cell_disabled[_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{opacity:.36}.t-cell[_ngcontent-%COMP%]:hover:not([data-range]) > .t-item[_ngcontent-%COMP%]{background:var(--tui-background-neutral-1-hover)}.t-cell[_ngcontent-%COMP%]:active:not([data-range]) > .t-item[_ngcontent-%COMP%]{background:var(--tui-background-neutral-1-pressed)}[_nghost-%COMP%]{inline-size:15.75rem}[data-type=weekday][_ngcontent-%COMP%]{color:var(--tui-text-primary)}[data-type=weekend][_ngcontent-%COMP%]{color:var(--tui-text-negative)}.t-row[_ngcontent-%COMP%]{justify-content:flex-start}.t-row[_ngcontent-%COMP%]:first-child{justify-content:flex-end}.t-row_weekday[_ngcontent-%COMP%]{font:var(--tui-font-text-s);color:var(--tui-text-secondary);pointer-events:none}.t-item[_ngcontent-%COMP%]{display:flex;flex-direction:column}.t-item_unavailable[_ngcontent-%COMP%]{opacity:var(--tui-disabled-opacity)}.t-dots[_ngcontent-%COMP%]{display:flex;justify-content:center;margin-top:-.5rem;padding-bottom:.25rem}.t-dot[_ngcontent-%COMP%]{display:inline-block;inline-size:.25rem;block-size:.25rem;border-radius:100%;margin:0 .0625rem}'],
  changeDetection: 0
});
var TuiCalendarSheet = _TuiCalendarSheet;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiCalendarSheet, [{
    ...
    args: [{
      ...
      imports: [CommonModule, TuiLet, TuiMapperPipe, TuiRepeatTimes, TuiHovered, TuiCalendarSheetPipe, TuiOrderWeekDaysPipe],
      changeDetection: ChangeDetectionStrategy.OnPush,
      host: {
...
var _TuiCalendarSpin = class _TuiCalendarSpin {
  constructor() {
...
_TuiCalendarSpin.ɵfac = function TuiCalendarSpin_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendarSpin)();
};
_TuiCalendarSpin.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiSpinButton, TuiLink, TuiMonthPipe, NgIf, AsyncPipe],
  styles: ["[_nghost-%COMP%]{display:block}"],
  changeDetection: 0
});
var TuiCalendarSpin = _TuiCalendarSpin;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiCalendarSpin, [{
    ...
    args: [{
      ...
      imports: [TuiSpinButton, TuiLink, TuiMonthPipe, NgIf, AsyncPipe],
      changeDetection: ChangeDetectionStrategy.OnPush,
...
var LIMIT = 100;
var ITEMS_IN_ROW = 4;
var _TuiCalendarYear = class _TuiCalendarYear {
  constructor() {
    this.hoveredItem = null;
  ...
  getItemRange(item) {
    ...
    return value.from.yearSame(value.to) && value.from.year === item ? "single" : null;
  }
  itemIsInterval(item) {
    const {
      value,
...
_TuiCalendarYear.ɵfac = function TuiCalendarYear_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendarYear)();
};
_TuiCalendarYear.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiHovered, TuiRepeatTimes, TuiLet, TuiScrollIntoView],
  styles: ['[_nghost-%COMP%]{display:block;font:var(--tui-font-text-m)}.t-row[_ngcontent-%COMP%]{position:relative;display:flex;justify-content:space-between;block-size:2.25rem;isolation:isolate}.t-item[_ngcontent-%COMP%]{position:relative;flex:1;line-height:2rem;border-radius:var(--tui-radius-m)}.t-item[_ngcontent-%COMP%]:before, .t-item[_ngcontent-%COMP%]:after{position:absolute;top:0;left:0;bottom:0;right:0;content:"";z-index:-1;border-radius:var(--tui-radius-m)}.t-item[_ngcontent-%COMP%]:after{border-radius:.5rem}.t-cell[_ngcontent-%COMP%]{position:relative;display:flex;align-items:center;justify-content:center;inline-size:3.9375rem;text-align:center;outline:none;cursor:pointer;background-clip:content-box;box-sizing:border-box;border:.125rem solid transparent}.t-cell[_ngcontent-%COMP%]:before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;z-index:-1;border-radius:var(--tui-radius-m)}.t-cell_today[_ngcontent-%COMP%]:after{position:absolute;left:50%;transform:translate(-50%);content:"";bottom:.3125rem;block-size:.125rem;inline-size:.75rem;border-radius:.375rem;background:var(--tui-text-primary)}.t-cell_interval[_ngcontent-%COMP%]:before{background:var(--tui-background-base-alt)}._single[_nghost-%COMP%]   .t-cell_interval[_ngcontent-%COMP%]:before{background:var(--tui-background-neutral-1-hover)}.t-cell_interval[_ngcontent-%COMP%]:not(:last-child):before{right:-.1875rem;border-start-end-radius:0;border-end-end-radius:0}.t-cell_interval[_ngcontent-%COMP%]:not([data-range=start]):not(:first-child):before{border-start-start-radius:0;border-end-start-radius:0}.t-cell_interval[_ngcontent-%COMP%]:last-child:first-child:before{right:0}.t-cell_interval[_ngcontent-%COMP%]:first-child > .t-item[_ngcontent-%COMP%]{border-start-start-radius:var(--tui-radius-m);border-end-start-radius:var(--tui-radius-m)}.t-cell_interval[_ngcontent-%COMP%]:last-child > .t-item[_ngcontent-%COMP%]{border-start-end-radius:var(--tui-radius-m);border-end-end-radius:var(--tui-radius-m)}.t-cell_interval[_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{border-radius:0}.t-cell[data-range][_ngcontent-%COMP%]:after{background:var(--tui-text-primary-on-accent-1)}.t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{color:var(--tui-text-primary-on-accent-1)}.t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1)}.t-cell[data-range][_ngcontent-%COMP%]:hover > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%]:hover > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1-hover)}.t-cell[data-range][_ngcontent-%COMP%]:active > .t-item[_ngcontent-%COMP%]:before, .t-cell[data-range][_ngcontent-%COMP%]:active > .t-item[_ngcontent-%COMP%]:after{background:var(--tui-background-accent-1-pressed)}.t-cell[data-range=end][_ngcontent-%COMP%]:before{background:var(--tui-background-base-alt)}._single[_nghost-%COMP%]   .t-cell[data-range=end][_ngcontent-%COMP%]:before{background:var(--tui-background-neutral-1-hover)}.t-cell[data-range=end][_ngcontent-%COMP%]:not(:first-child):before{border-start-start-radius:0;border-end-start-radius:0}.t-cell[data-range=end][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before{left:.625rem;border-start-start-radius:0;border-end-start-radius:0}.t-cell[data-range=end][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{left:-2rem;right:100%;transform:translate(1.6rem) scaleY(.83) scaleX(.5) rotate(45deg)}.t-cell[data-range=start][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:before{right:.625rem;border-start-end-radius:0;border-end-end-radius:0}.t-cell[data-range=start][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{left:100%;right:-2rem;transform:translate(-1.6rem) scaleY(.83) scaleX(.5) rotate(45deg)}.t-cell[data-range=single][_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]:after{display:none}.t-cell_disabled[_ngcontent-%COMP%]{pointer-events:none}.t-cell_disabled[_ngcontent-%COMP%] > .t-item[_ngcontent-%COMP%]{opacity:.36}.t-cell[_ngcontent-%COMP%]:hover:not([data-range]) > .t-item[_ngcontent-%COMP%]{background:var(--tui-background-neutral-1-hover)}.t-cell[_ngcontent-%COMP%]:active:not([data-range]) > .t-item[_ngcontent-%COMP%]{background:var(--tui-background-neutral-1-pressed)}[_nghost-%COMP%]{inline-size:15.75rem}.t-row[_ngcontent-%COMP%]{margin:.875rem 0}.t-row[_ngcontent-%COMP%]:first-child{margin-top:0}.t-row[_ngcontent-%COMP%]:last-child{margin-bottom:0}'],
  changeDetection: 0
});
var TuiCalendarYear = _TuiCalendarYear;
(() => {
...
var _TuiCalendar = class _TuiCalendar {
  constructor() {
    this.day = null;
    this.view = "month";
    this.month = TuiMonth.currentLocal();
...
_TuiCalendar.ɵfac = function TuiCalendar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiCalendar)();
};
_TuiCalendar.ɵcmp = ɵɵdefineComponent({
  type: _TuiCalendar,
  ...
  dependencies: [NgIf, TuiScrollbar, TuiCalendarYear, TuiCalendarSpin, TuiCalendarSheet, TuiMapperPipe],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiCalendar, [{
    ...
    args: [{
      ...
      imports: [NgIf, TuiScrollbar, TuiCalendarYear, TuiCalendarSpin, TuiCalendarSheet, TuiMapperPipe],
      changeDetection: ChangeDetectionStrategy.OnPush,
...
//# sourceMappingURL=chunk-M7KV4JTE.js.map
