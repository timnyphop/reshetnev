...
import {
  TuiClickOutside
} from "./chunk-7DAWLRTP.js";
import {
  TuiSwipe
} from "./chunk-FYZ36TWN.js";
import "./chunk-7C2SET26.js";
import {
  EMPTY_QUERY,
  MONTHS_IN_YEAR,
...
_TuiDropdownMobileComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [WaIntersectionObserverDirective, WaIntersectionObservee, TuiSwipe, NgIf, PolymorpheusOutlet],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiDropdownMobileComponent, [{
    ...
    args: [{
      ...
      imports: [WaIntersectionObserver, TuiSwipe, NgIf, PolymorpheusOutlet, PolymorpheusTemplate],
      encapsulation: ViewEncapsulation$1.None,
      changeDetection: ChangeDetectionStrategy.OnPush,
  ...
  hostBindings: function TuiRipple_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("pointerdown.silent", function TuiRipple_pointerdown_silent_HostBindingHandler($event) {
        return ctx.start($event.clientX, $event.clientY, $event.target);
      });
    }
  },
  inputs: {
    selector: [2, "tuiRipple", "selector", selectorScopeFallback]
  },
  standalone: true,
...
_TuiSidebarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiActiveZone, PolymorpheusOutlet],
...
function TuiMobileCalendarSheet_ng_container_0_div_1_ng_container_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 5);
    ɵɵlistener("click", function TuiMobileCalendarSheet_ng_container_0_div_1_ng_container_1_div_1_Template_div_click_0_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(4);
    ɵɵclassProp("t-cell_disabled", ctx_r2.disabledItemHandler(item_r2))("t-cell_interval", ctx_r2.itemIsInterval(item_r2))("t-cell_today", ctx_r2.itemIsToday(item_r2));
    ɵɵattribute("data-range", ctx_r2.getItemRange(item_r2));
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", item_r2.day, " ");
  }
}
function TuiMobileCalendarSheet_ng_container_0_div_1_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiMobileCalendarSheet_ng_container_0_div_1_ng_container_1_div_1_Template, 2, 8, "div", 4);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function TuiMobileCalendarSheet_ng_container_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, TuiMobileCalendarSheet_ng_container_0_div_1_ng_container_1_Template, 2, 1, "ng-container", 3);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    const sheet_r6 = ɵɵnextContext().tuiLet;
    ɵɵadvance();
    ɵɵproperty("tuiRepeatTimesOf", (tmp_4_0 = sheet_r6[rowIndex_r5] == null ? null : sheet_r6[rowIndex_r5].length) !== null && tmp_4_0 !== void 0 ? tmp_4_0 : 0);
  }
}
function TuiMobileCalendarSheet_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiMobileCalendarSheet_ng_container_0_div_1_Template, 2, 1, "div", 1);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
_TuiMobileCalendarSheet.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 2,
  vars: 3,
  consts: [[4, "tuiLet"], ["automation-id", "tui-primitive-calendar-mobile__row", "class", "t-row", 4, "tuiRepeatTimes", "tuiRepeatTimesOf"], ["automation-id", "tui-primitive-calendar-mobile__row", 1, "t-row"], [4, "tuiRepeatTimes", "tuiRepeatTimesOf"], ["automation-id", "tui-primitive-calendar-mobile__cell", "tuiRipple", "", "class", "t-cell", 3, "t-cell_disabled", "t-cell_interval", "t-cell_today", "click", 4, "ngIf"], ["automation-id", "tui-primitive-calendar-mobile__cell", "tuiRipple", "", 1, "t-cell", 3, "click"]],
...
var _TuiMobileCalendar = class _TuiMobileCalendar {
  ...
  setYear(year) {
    ...
    timer(0).pipe(tuiZonefree(this.ngZone), takeUntilDestroyed(this.destroyRef)).subscribe(() => this.scrollToActiveMonth());
  }
  set value(value) {
  ...
  initYearScroll() {
    ...
    touchstart$.pipe(switchMap(() => touchend$), switchMap(() => race(yearsScrollRef.elementScrolled(), timer(SCROLL_DEBOUNCE_TIME)).pipe(debounceTime(SCROLL_DEBOUNCE_TIME * 2), take(1), takeUntil(touchstart$))), takeUntilDestroyed(this.destroyRef)).subscribe(() => this.scrollToActiveYear("smooth"));
  }
  initMonthScroll() {
    const {
      monthsScrollRef
    ...
    touchstart$.pipe(switchMap(() => touchend$), switchMap(() => race(monthsScrollRef.elementScrolled(), timer(SCROLL_DEBOUNCE_TIME)).pipe(debounceTime(SCROLL_DEBOUNCE_TIME * 2), take(1), takeUntil(touchstart$))), takeUntilDestroyed(this.destroyRef)).subscribe(() => this.scrollToActiveMonth("smooth"));
  }
...
_TuiMobileCalendar.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiButton, AsyncPipe, TuiRipple, TuiLink, TuiTouchable, CdkFixedSizeVirtualScroll, CdkVirtualScrollViewport, CdkVirtualForOf, TuiOrderWeekDaysPipe, TuiMobileCalendarSheet, TuiMonthPipe, NgForOf, NgIf, TuiMapperPipe],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiMobileCalendar, [{
    ...
    args: [{
      ...
      imports: [TuiButton, AsyncPipe, TuiRipple, TuiLink, TuiTouchable, CdkFixedSizeVirtualScroll, CdkVirtualScrollViewport, CdkVirtualForOf, TuiOrderWeekDaysPipe, TuiMobileCalendarSheet, TuiMonthPipe, NgForOf, NgIf, TuiMapperPipe],
      changeDetection: ChangeDetectionStrategy.OnPush,
...
_TuiMobileDialog.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [NgIf, PolymorpheusOutlet, NgForOf, TuiButton, TuiRipple],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiMobileDialog, [{
    ...
    args: [{
      ...
      imports: [NgIf, PolymorpheusOutlet, PolymorpheusTemplate, NgForOf, TuiButton, TuiRipple],
      changeDetection: ChangeDetectionStrategy.OnPush,
      host: {
        "[class._ios]": "isIOS"
      },
...
_TuiMobileLoaderIOS.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [TuiRepeatTimes, NgIf],
...
_TuiSheetDialogComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [NgForOf, TuiClickOutside, NgIf, PolymorpheusOutlet, TuiButton, AsyncPipe],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiSheetDialogComponent, [{
    ...
    args: [{
      ...
      imports: [NgForOf, TuiClickOutside, NgIf, PolymorpheusOutlet, PolymorpheusTemplate, TuiButton, AsyncPipe],
      changeDetection: ChangeDetectionStrategy.OnPush,
