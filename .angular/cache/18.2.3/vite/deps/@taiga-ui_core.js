...
function TuiError_ng_container_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, TuiError_ng_container_0_div_1_ng_container_1_Template, 2, 1, "ng-container", 3);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const defaultErrorMessage_r2 = ɵɵnextContext().tuiLet;
    const ctx_r2 = ɵɵnextContext();
    ɵɵproperty("@tuiFadeIn", ctx_r2.options)("@tuiHeightCollapse", ctx_r2.options);
    ɵɵadvance();
    ɵɵproperty("polymorpheusOutlet", ctx_r2.error.message || defaultErrorMessage_r2)("polymorpheusOutletContext", ctx_r2.error.context || ɵɵpureFunction0(4, _c0));
  }
}
function TuiError_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TuiError_ng_container_0_div_1_Template, 2, 5, "div", 1);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r2.error && ctx_r2.visible);
  }
}
...
_TuiError.ɵcmp = ɵɵdefineComponent({
  ...
  template: function TuiError_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, TuiError_ng_container_0_Template, 2, 1, "ng-container", 0);
      ɵɵpipe(1, "async");
    }
    if (rf & 2) {
...
var _TuiDateFormat = class _TuiDateFormat extends Observable {
  constructor() {
...
_TuiDateFormat.ɵfac = function TuiDateFormat_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiDateFormat)();
};
_TuiDateFormat.ɵdir = ɵɵdefineDirective({
  type: _TuiDateFormat,
...
var TuiDateFormat = _TuiDateFormat;
(() => {
...
var _TuiSurfaceStyles = class _TuiSurfaceStyles {
};
_TuiSurfaceStyles.ɵfac = function TuiSurfaceStyles_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiSurfaceStyles)();
};
_TuiSurfaceStyles.ɵcmp = ɵɵdefineComponent({
...
var TuiSurfaceStyles = _TuiSurfaceStyles;
(() => {
...
var _TuiSurface = class _TuiSurface {
  constructor() {
    this.nothing = tuiWithStyles(TuiSurfaceStyles);
    this.tuiSurface = "";
  }
};
_TuiSurface.ɵfac = function TuiSurface_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TuiSurface)();
};
_TuiSurface.ɵdir = ɵɵdefineDirective({
  type: _TuiSurface,
...
_TuiRoot.ɵcmp = ɵɵdefineComponent({
  type: _TuiRoot,
  selectors: [["tui-root"]],
  hostAttrs: ["data-tui-version", "4.5.0"],
  hostVars: 6,
  hostBindings: function TuiRoot_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("touchstart.passive.silent", function TuiRoot_touchstart_passive_silent_HostBindingHandler() {
        return 0;
      });
    }
    if (rf & 2) {
  ...
  standalone: true,
  features: [ɵɵHostDirectivesFeature([TuiPlatform]), ɵɵStandaloneFeature],
  ...
  template: function TuiRoot_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(0, TuiRoot_tui_scroll_controls_0_Template, 1, 0, "tui-scroll-controls", 0);
      ɵɵpipe(1, "async");
      ɵɵelementStart(2, "tui-dropdowns")(3, "div", 1);
      ɵɵprojection(4);
      ɵɵelementEnd();
      ɵɵprojection(5, 1);
  ...
  dependencies: [NgIf, AsyncPipe, TuiDropdowns, TuiDialogs, TuiAlerts, TuiHints, TuiScrollControls],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiRoot, [{
    ...
    args: [{
      standalone: true,
      selector: "tui-root",
      imports: [NgIf, AsyncPipe, TuiDropdowns, TuiDialogs, TuiAlerts, TuiHints, TuiScrollControls],
      encapsulation: ViewEncapsulation$1.None,
