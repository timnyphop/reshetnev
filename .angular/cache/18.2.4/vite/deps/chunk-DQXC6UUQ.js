...
var _c02 = ["vcr"];
var _c12 = [[["input"]], [["select"]], [["label"]], "*", [["tui-icon"]]];
...
_TuiTextfieldComponent.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function TuiTextfieldComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ...
      ɵɵclassProp("_with-label", ctx.hasLabel)("_with-template", ctx.content)("_disabled", ctx.el == null ? null : ctx.el.nativeElement.disabled);
    }
  },
  inputs: {
    filler: "filler",
  ...
  features: [ɵɵProvidersFeature([tuiAsDataListHost(_TuiTextfieldComponent), tuiDropdownOptionsProvider({
    limitWidth: "fixed"
  })]), ɵɵHostDirectivesFeature([TuiDropdownDirective, TuiWithDropdownOpen, TuiWithTextfieldDropdown, TuiWithIcons]), ɵɵStandaloneFeature],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiTextfieldComponent, [{
    ...
    args: [{
      ...
      hostDirectives: [TuiDropdownDirective, TuiWithDropdownOpen, TuiWithTextfieldDropdown, TuiWithIcons],
      host: {
...
//# sourceMappingURL=chunk-DQXC6UUQ.js.map
