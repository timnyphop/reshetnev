...
var _c04 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
...
function TuiCalendarSheet_div_4_div_1_ng_container_1_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", ɵɵpipeBindV(4, 13, ɵɵpureFunction5(19, _c04, item_r3, ctx_r3.toMarkers, ctx_r3.itemIsToday(item_r3), ctx_r3.getItemRange(item_r3), ctx_r3.markerHandler)));
  }
}
...
var _TuiDataListComponent = class _TuiDataListComponent {
  ...
  ngAfterContentChecked() {
    timer(0, tuiZonefreeScheduler(this.ngZone)).pipe(tuiTakeUntilDestroyed(this.destroyRef)).subscribe(() => this.empty.set(!this.el.querySelector("[tuiOption]")));
  }
...
//# sourceMappingURL=chunk-Q7UIJALW.js.map
