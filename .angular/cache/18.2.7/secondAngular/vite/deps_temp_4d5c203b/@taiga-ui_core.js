...
import "./chunk-LHDXMYNZ.js";
import "./chunk-4QYX4UXE.js";
import "./chunk-UZPV3B5J.js";
import {
  PolymorpheusOutlet,
  TUI_IS_MOBILE,
  TUI_VERSION,
...
var TuiRoot = class _TuiRoot {
  constructor() {
    ...
    this.scrollbars = inject(TUI_IS_MOBILE) ? signal(false) : toSignal(inject(TUI_DIALOGS).pipe(map(({
      length
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _TuiRoot,
      selectors: [["tui-root"]],
      hostAttrs: ["data-tui-version", "4.9.0"],
      hostVars: 6,
      ...
      template: function TuiRoot_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵelementStart(1, "tui-dropdowns")(2, "div", 1);
          ɵɵprojection(3);
          ɵɵelementEnd();
          ɵɵprojection(4, 1);
          ɵɵelement(5, "tui-dialogs");
          ɵɵprojection(6, 2);
          ɵɵelement(7, "tui-alerts");
          ɵɵprojection(8, 3);
          ɵɵelementEnd();
          ɵɵprojection(9, 4);
