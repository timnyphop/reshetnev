...
import {
  TuiElement
} from "./chunk-UNQZX4ZS.js";
import {
  TuiClickOutside
} from "./chunk-2LEH3WPP.js";
import {
  TUI_SWIPE_OPTIONS,
  TuiSwipe,
  TuiSwipeService
...
var TuiNgControl = class _TuiNgControl {
  ...
  static {
    this.ɵfac = function TuiNgControl_Factory(__ngFactoryType__) {
...
var TuiCopyProcessor = class _TuiCopyProcessor {
  constructor() {
...
var TuiDroppable = class _TuiDroppable {
  constructor() {
  ...
  static {
    this.ɵfac = function TuiDroppable_Factory(__ngFactoryType__) {
...
var TuiFor = class _TuiFor {
  ...
  static {
    this.ɵfac = function TuiFor_Factory(__ngFactoryType__) {
...
var TuiResizable = class _TuiResizable extends TuiElement {
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
...
var TuiResizer = class _TuiResizer {
  constructor() {
  ...
  static {
    this.ɵfac = function TuiResizer_Factory(__ngFactoryType__) {
...
var TuiValueChanges = class _TuiValueChanges {
  constructor() {
...
var TuiFilterPipe = class _TuiFilterPipe {
  /**
...
var TuiIsPresentPipe = class _TuiIsPresentPipe {
  transform(value) {
    return tuiIsPresent(value);
  }
  static {
    this.ɵfac = function TuiIsPresentPipe_Factory(__ngFactoryType__) {
...
var TuiKeysPipe = class _TuiKeysPipe {
  transform(object) {
    return Object.keys(object);
  }
  static {
    this.ɵfac = function TuiKeysPipe_Factory(__ngFactoryType__) {
...
// node_modules/@taiga-ui/cdk/fesm2022/taiga-ui-cdk-pipes-repeat-times.mjs
var TuiRepeatTimesPipe = class _TuiRepeatTimesPipe {
  transform(n) {
    return Array.from({
      length: tuiClamp(n, 0, n)
    }, (_, i) => i);
  }
  static {
    this.ɵfac = function TuiRepeatTimesPipe_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _TuiRepeatTimesPipe)();
    };
  }
  static {
    this.ɵpipe = ɵɵdefinePipe({
      name: "tuiRepeatTimes",
      type: _TuiRepeatTimesPipe,
      pure: true,
      standalone: true
    });
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiRepeatTimesPipe, [{
    type: Pipe,
    args: [{
      standalone: true,
      name: "tuiRepeatTimes"
...
var TuiReplacePipe = class _TuiReplacePipe {
  ...
  static {
    this.ɵfac = function TuiReplacePipe_Factory(__ngFactoryType__) {
...
var TuiToArrayPipe = class _TuiToArrayPipe {
  transform(items) {
    return Array.from(items);
  }
  static {
    this.ɵfac = function TuiToArrayPipe_Factory(__ngFactoryType__) {
